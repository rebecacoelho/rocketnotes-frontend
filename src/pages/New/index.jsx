...
export function New() {
  ...
  function handleAddLink() {
    setLinks(prevState => [...prevState, newLink]); // pega o que tinha antes e adiciona o newLink
    setNewLink("");
  }
  ...
  function handleAddTag() {
    setTags(prevState => [...prevState, newTag]); // pega o que tinha antes e adiciona o newTag
    setNewTag("");
  }
  ...
  async function handleNewNote() {
    ...
    alert("Nota criada com sucessso!");
    navigate(-1);
  }
          ...
          <Section title="Links Úteis">
            {
              links.map((link, index) => (
                <NoteItem key={String(index)} value={link} onClick={() => handleRemoveLink(link)}/> // com parametro tem que ser arrow function
              ))
            }
